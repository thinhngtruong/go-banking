...
func (c *simpleBankClient) UpdateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*CreateUserResponse, error) {
...
func (UnimplementedSimpleBankServer) UpdateUser(context.Context, *CreateUserRequest) (*CreateUserResponse, error) {
...
func _SimpleBank_UpdateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SimpleBankServer).UpdateUser(ctx, req.(*CreateUserRequest))
	}
...
var SimpleBank_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "service_simple_bank_proto.proto",
}
